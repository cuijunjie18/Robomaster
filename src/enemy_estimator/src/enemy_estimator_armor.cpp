...
#include <enemy_estimator/enemy_estimator_utils.h>
...
int EnemyEstimatorNode::get_armor_cnt(armor_type type) {
    switch (type) {
...
bool EnemyEstimatorNode::is_big_armor(armor_type type) { return enemy_armor_type[type]; }

void EnemyEstimatorNode::update_armors() {
